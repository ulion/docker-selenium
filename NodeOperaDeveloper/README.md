# Selenium Grid Node - Opera Developer

Selenium Node configured to run Opera Developer

## Dockerfile

[`ulion/selenium-node-opera-developer` Dockerfile](https://github.com/ulion/docker-selenium/blob/master/NodeOperaDeveloper/Dockerfile)
...
```
$ docker run -d --link selenium-hub:hub ulion/selenium-node-opera-developer
```
